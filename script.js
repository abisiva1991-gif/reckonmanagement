...
document.querySelectorAll('.case-card, .why-card, .problem-item, .svc-item, .sector-point, .tl-item, .qual-row, .engagement, .cred, .testi-card-full, .contact-detail, .ns-item').forEach((el, i) => {
...
if (form) {
  form.addEventListener('submit', e => {
    ...
    btn.disabled = true;
    btn.style.cssText = 'width:100%;justify-content:center;font-size:.9rem;padding:14px;background:#2E7D5E;border-color:#2E7D5E;color:#fff;opacity:1;cursor:default;border-radius:6px;font-family:inherit;';
  });
}
